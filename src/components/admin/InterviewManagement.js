...
const InterviewManagement = () => {
  ...
  const getPaymentBadgeClass = (status) => {
    switch (status) {
      case 'unpaid': return 'badge-secondary';
  ...
  return (
    <div className="interview-management">
      ...
      {loading ? (
        ...
        <div className="no-interviews">No interviews found matching your filters.</div>
      ) : (
        <>
              ...
              <tbody>
                {interviews.map(interview => (
                  <tr key={interview._id}>
                    ...
                    <td>
                      <span className={`status-badge ${getPaymentBadgeClass(interview.paymentStatus)}`}>
                        {interview.paymentStatus}
                      </span>
                    </td>
                    <td>₹{interview.price ? interview.price / 100 : 'N/A'}</td>
                  </tr>
                ))}
              </tbody>
            </table>
